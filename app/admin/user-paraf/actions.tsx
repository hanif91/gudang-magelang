...
import { encrypt } from "@/lib/crypto"
import { deleteMerek } from "@/lib/actions/actMerek"
import { mutate } from "swr"
import { deleteUserParaf } from "@/lib/actions/actUserParaf"
...
export default function Actions({ id }: { id: string }) {
  ...
  const deleteAction = (id: string) => {
    startTransition(async () => {
      const data = await deleteUserParaf(id)
      ...
      <DropdownMenu modal={false}>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem asChild>
            <Link href={`/admin/user-paraf/edit?id=${encodeURIComponent(encrypt(id))}`}>
