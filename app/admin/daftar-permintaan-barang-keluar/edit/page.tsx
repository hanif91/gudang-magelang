...
import { getDpbk } from "@/lib/actions/actDpbk"
    ...
    <Fragment>
      <main className="flex flex-col gap-5 justify-center content-center p-5">
        <Card className="w-full">
          <CardHeader>
            <CardTitle>Edit Daftar Permintaan Barang Keluar</CardTitle>
            <CardDescription>Edit Daftar Permintaan Barang Keluar Form</CardDescription>
          </CardHeader>
          <CardContent className="py-0">
            <DataForm dpbk={data.data[0]} />
          </CardContent>
