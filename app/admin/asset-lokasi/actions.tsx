...
import { deleteAssetLokasi } from "@/lib/actions/actAssetLokasi"
...
export default function Actions({ id }: { id: string }) {
  ...
  const deleteAction = (id: string) => {
    startTransition(async () => {
      const data = await deleteAssetLokasi(id)
      ...
      if (data.success) {
        ...
        mutate('/api/gudang/asset-lokasi')
      } else {
        toast({
          variant: "destructive",
          description: (
      ...
      <DropdownMenu modal={false}>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem asChild>
            <Link href={`/admin/asset-lokasi/edit?id=${encodeURIComponent(encrypt(id))}`}>
