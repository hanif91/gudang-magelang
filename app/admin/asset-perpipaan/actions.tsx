...
import { deleteAssetPerpipaan } from "@/lib/actions/actAssetPerpipaan"
export default function Actions({ id }: { id: string }) {
  ...
  const deleteAction = (id: string) => {
    startTransition(async () => {
      const data = await deleteAssetPerpipaan(id)
      ...
      <DropdownMenu modal={false}>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem asChild>
            <Link href={`/admin/asset-perpipaan/edit?id=${encodeURIComponent(encrypt(id))}`}>
