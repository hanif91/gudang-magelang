			...
			<Card className="w-full">
				<CardHeader className="py-4">
					<div className="flex flex-row items-center justify-between space-x-5">
						...
						<div className="flex flex-row items-center justify-start space-x-5">
							<Link href="/admin/pembelian/create-non-rekanan" className="flex justify-end">
								<Button variant="default" className="min-w-32">
									<Plus className="w-4 h-4 mr-1" /> Tambah Pembelian Non Rekanan
								</Button>
							</Link>
							<Link href="/admin/pembelian/create-rekanan" className="flex justify-end">
								<Button variant="default" className="min-w-32">
									<Plus className="w-4 h-4 mr-1" /> Tambah Pembelian Full Rekanan
								</Button>
							</Link>
						</div>
					</div>
