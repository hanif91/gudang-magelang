...
import { deleteAssetWilayah } from "@/lib/actions/actAssetWilayah"
...
export default function Actions({ id }: { id: string }) {
  ...
  const deleteAction = (id: string) => {
    startTransition(async () => {
      const data = await deleteAssetWilayah(id)
      ...
      if (data.success) {
        ...
        mutate('/api/gudang/asset-wilayah')
      } else {
        toast({
          variant: "destructive",
          description: (
      ...
      <DropdownMenu modal={false}>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem asChild>
            <Link href={`/admin/asset-wilayah/edit?id=${encodeURIComponent(encrypt(id))}`}>
