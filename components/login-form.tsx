            ...
            <div className="grid gap-5">
              <div className="flex flex-col gap-5">
                <Button variant="outline"  asChild>
                  <Link  className="w-full" href="/login/google">
                    <svg className="w-6 h-6 m-4" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24">
                      <path
              ...
              <div className={`${state ? "flex" : "hidden"} grow m-auto text-red-500 italic text-sm text-center`}>
                Your Email Not Registred. Please Contact Administrator
              </div>
