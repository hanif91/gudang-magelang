...
export const verifyAllBarangKeluar = async (nobpp: string | null, data: any) => {
    try {
        const response = await AxiosClient.put(
            `/api/gudang/barang-keluar/verifikasi/${nobpp}`,
            data
        );
        return response.data;
    } catch (error) {
...
export const verifyBarangKeluarJenis = async (jenisBkId: string | null, data: any) => {
    try {
        const response = await AxiosClient.put(
            `/api/gudang/barang-keluar/verifikasi-jenis/${jenisBkId}`,
            data
        );
        return response.data;
    } catch (error) {
